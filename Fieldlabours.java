...
public class Fieldlabours extends Activity {
	...
	private static final String NAMESPACE = "http://tempuri.org/";
	 ...
	 private static final String SOAP_ACTION = "http://tempuri.org/viewlabours";
	 private static final String METHOD_NAME = "viewlabours";
	 

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_fieldlabours);
		...
		ib_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(),Dealerlabours.class);
				startActivity(i);
...
//	s_tno= preferences.getString("tno","0");
    ...
    lv_items.setOnItemClickListener(new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, final int arg2,
			...
			LayoutInflater li = LayoutInflater.from(Fieldlabours.this);
			View promptsView = li.inflate(R.layout.addtowallet, null);

			AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Fieldlabours.this);
...
public void webmethod() {
    	...
    	if(checkInternetConnection()) {
			pbar = ProgressDialog.show(Fieldlabours.this,"","Fetching Information");
